...
action_routes = Blueprint('action', __name__)


@action_routes.route('/action/<int:action_id>', methods=['GET'])
...
@action_routes.route('/action/<int:car_id>', methods=['POST'])
...
@action_routes.route('/action/<int:action_id>', methods=['PUT'])
...
@action_routes.route('/action/<int:action_id>', methods=['DELETE'])
