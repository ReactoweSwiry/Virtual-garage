...
export default function MaintenanceDetailsModal({ visible, onDismiss, event }: MaintenanceDetailsModalProps) {
    ...
    return (
        <Portal>
            ...
            >
                <ScrollView>
                    <Text style={styles.modalTitle}>{event.type || event.action}</Text>
                    <Divider style={styles.divider} />
                    <List.Item
                        title="Title"
                        description={event.action}
                        left={props => <List.Icon {...props} icon={getIconForEventType(event.type)} />}
                    />
                    <List.Item
                        title="Date"
